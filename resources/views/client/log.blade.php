                ...
                <x-bladewind::card class="!p-4 hover:shadow-md transition-shadow border-dashed">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <h3 class="text-base font-semibold text-gray-900">Custom Workout</h3>
                                <p class="text-sm text-gray-500">Log a workout not in your program</p>
                            </div>
                        </div>
                        <svg class="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
        ...
        @else
            <x-bladewind::card class="!p-6">
                <div class="text-center py-8">
                    ...
                    <p class="mt-4 text-gray-600">No active program assigned yet.</p>
                    <p class="mt-1 text-sm text-gray-500">Ask your coach to assign you a program, or log a custom workout.</p>
                </div>
            </x-bladewind::card>
