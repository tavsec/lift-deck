    ...
    <div class="flex flex-col h-[calc(100vh-10rem)]">
        ...
        <div class="flex items-center pb-4 border-b border-gray-200 dark:border-gray-800">
            ...
            <div class="ml-3">
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400">{{ __('client.messages.your_coach') }}</p>
            </div>
        </div>
        ...
        <div id="messages-container" class="flex-1 overflow-y-auto py-4 space-y-4">
            ...
            @empty
                <div class="text-center py-12">
                    ...
                    <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">{{ __('client.messages.no_messages') }}</p>
                </div>
            @endforelse
        </div>
