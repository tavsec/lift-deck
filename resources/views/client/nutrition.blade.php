                    ...
                    <div x-show="libraryMeals.length > 0" class="max-h-60 overflow-y-auto space-y-2">
                        <template x-for="meal in libraryMeals" :key="meal.id">
                            <button @click="selectLibraryMeal(meal)" type="button"
                                :class="selectedMeal && selectedMeal.id === meal.id ? 'border-blue-500 bg-blue-50 dark:bg-blue-900/20' : 'border-gray-200 dark:border-gray-800 hover:bg-gray-50 dark:hover:bg-gray-800'"
                                ...
                                <div class="flex flex-wrap gap-2">
                                    <template x-for="type in mealTypes" :key="type">
                                        <button type="button" @click="mealType = type; customMealType = ''"
                                            :class="mealType === type && !customMealType ? 'bg-blue-600 text-white border-blue-600' : 'bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300 border-gray-300 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700'"
                            ...
                            <div class="flex flex-wrap gap-2">
                                <template x-for="type in mealTypes" :key="type">
                                    <button type="button" @click="customFormMealType = type; customFormCustomType = ''"
                                        :class="customFormMealType === type && !customFormCustomType ? 'bg-blue-600 text-white border-blue-600' : 'bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300 border-gray-300 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700'"
                                        class="px-3 py-1.5 text-sm font-medium border rounded-md transition-colors" x-text="type">
                                    </button>
                                </template>
                            </div>
