<x-layouts.coach>
    ...
    <div class="space-y-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
                <h1 class="text-2xl font-bold text-gray-900 dark:text-gray-100">{{ __('coach.programs.index.heading') }}</h1>
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">{{ __('coach.programs.index.subtitle') }}</p>
            </div>
        ...
        <div class="bg-white dark:bg-gray-900 rounded-lg shadow p-4">
            <form method="GET" action="{{ route('coach.programs.index') }}" class="flex flex-col sm:flex-row gap-4">
                <div class="flex-1">
                    <input type="text" name="search" value="{{ request('search') }}" placeholder="{{ __('coach.programs.index.search_placeholder') }}" class="w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-100 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm">
                </div>
                <div class="sm:w-40">
                ...
                <label class="inline-flex items-center">
                    ...
                    <span class="ml-2 text-sm text-gray-600 dark:text-gray-400">{{ __('coach.programs.index.templates_only') }}</span>
                </label>
        ...
        @else
            <div class="bg-white dark:bg-gray-900 rounded-lg shadow">
                <div class="text-center py-12">
                    ...
                    <h3 class="mt-2 text-sm font-medium text-gray-900 dark:text-gray-100">{{ __('coach.programs.index.no_programs') }}</h3>
                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">{{ __('coach.programs.index.no_programs_description') }}</p>
                    <div class="mt-6">
