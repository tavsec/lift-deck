<x-layouts.coach>
    ...
    <div class="space-y-6">
        ...
        <div>
            ...
            <h1 class="text-2xl font-bold text-gray-900">{{ __('coach.rewards.create.heading') }}</h1>
            <p class="mt-1 text-sm text-gray-500">{{ __('coach.rewards.create.subtitle') }}</p>
        </div>
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <form method="POST" action="{{ route('coach.rewards.store') }}" enctype="multipart/form-data" class="space-y-6">
                ...
                <div>
                    <label for="name" class="block text-sm font-medium text-gray-700">{{ __('coach.rewards.create.name') }} <span class="text-red-500">*</span></label>
                ...
                <div>
                    <label for="description" class="block text-sm font-medium text-gray-700">{{ __('coach.rewards.create.description') }}</label>
                ...
                <div>
                    <label for="points_cost" class="block text-sm font-medium text-gray-700">{{ __('coach.rewards.create.points_cost') }} <span class="text-red-500">*</span></label>
                ...
                <div>
                    <label for="stock" class="block text-sm font-medium text-gray-700">{{ __('coach.rewards.create.stock') }}</label>
                ...
                <div>
                    <label for="image" class="block text-sm font-medium text-gray-700">{{ __('coach.rewards.create.image') }}</label>
