<x-layouts.coach>
    ...
    <div class="space-y-6">
        ...
        <div>
            ...
            <h1 class="text-2xl font-bold text-gray-900 dark:text-gray-100">{{ __('coach.clients.edit.heading') }}</h1>
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">{{ __('coach.clients.edit.subtitle') }}</p>
        </div>
        ...
        <div class="bg-white dark:bg-gray-900 rounded-lg shadow p-6">
            <form method="POST" action="{{ route('coach.clients.update', $client) }}" class="space-y-6">
                ...
                <div>
                    <label for="name" class="block text-sm font-medium text-gray-700 dark:text-gray-300">{{ __('coach.clients.edit.name') }} <span class="text-red-500">*</span></label>
                ...
                <div>
                    <label for="email" class="block text-sm font-medium text-gray-700 dark:text-gray-300">{{ __('coach.clients.edit.email') }}</label>
                    ...
                    <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">{{ __('coach.clients.edit.email_readonly') }}</p>
                </div>

                <div>
                    <label for="phone" class="block text-sm font-medium text-gray-700 dark:text-gray-300">{{ __('coach.clients.edit.phone') }}</label>
