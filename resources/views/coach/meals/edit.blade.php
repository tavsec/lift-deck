<x-layouts.coach>
    ...
    <div class="space-y-6">
        ...
        <div>
            ...
            <h1 class="text-2xl font-bold text-gray-900 dark:text-gray-100">{{ __('coach.meals.edit.heading') }}</h1>
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">{{ __('coach.meals.edit.subtitle') }}</p>
        </div>
        ...
        <div class="bg-white dark:bg-gray-900 rounded-lg shadow p-6">
            <form method="POST" action="{{ route('coach.meals.update', $meal) }}" class="space-y-6">
                ...
                <div>
                    <label for="name" class="block text-sm font-medium text-gray-700 dark:text-gray-300">{{ __('coach.meals.edit.name') }} <span class="text-red-500">*</span></label>
                ...
                <div>
                    <label for="description" class="block text-sm font-medium text-gray-700 dark:text-gray-300">{{ __('coach.meals.edit.description') }}</label>
                ...
                <div>
                    <label for="calories" class="block text-sm font-medium text-gray-700 dark:text-gray-300">{{ __('coach.meals.edit.calories') }} <span class="text-red-500">*</span></label>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    <div>
                        <label for="protein" class="block text-sm font-medium text-gray-700 dark:text-gray-300">{{ __('coach.meals.edit.protein') }} <span class="text-red-500">*</span></label>
                    ...
                    <div>
                        <label for="carbs" class="block text-sm font-medium text-gray-700 dark:text-gray-300">{{ __('coach.meals.edit.carbs') }} <span class="text-red-500">*</span></label>
                    ...
                    <div>
                        <label for="fat" class="block text-sm font-medium text-gray-700 dark:text-gray-300">{{ __('coach.meals.edit.fat') }} <span class="text-red-500">*</span></label>
        ...
        <!-- Archive -->
        <div class="bg-white dark:bg-gray-900 rounded-lg shadow p-6">
            <h2 class="text-lg font-medium text-red-900">{{ __('coach.meals.edit.archive_heading') }}</h2>
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">{{ __('coach.meals.edit.archive_description') }}</p>
            <div class="mt-4">
