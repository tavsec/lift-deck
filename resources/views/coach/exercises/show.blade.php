        ...
        <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
            ...
            @if($exercise->isCustom())
                <div class="flex gap-2">
                    <a href="{{ route('coach.exercises.edit', $exercise) }}" class="inline-flex items-center px-4 py-2 border border-gray-300 rounded-md font-medium text-sm text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition ease-in-out duration-150">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div class="bg-white rounded-lg shadow">
                        <div class="aspect-video flex items-center justify-center bg-gray-100">
                            <div class="text-center">
                                ...
                                <p class="mt-2 text-sm text-gray-500">No video available</p>
                            </div>
                        </div>
                    </div>
                @endif
            ...
            <div class="space-y-6">
                <div class="bg-white rounded-lg shadow p-6">
                    ...
                    <dl class="space-y-4">
                        <div>
                            <dt class="text-sm font-medium text-gray-500">Muscle Group</dt>
                            <dd class="mt-1 text-sm text-gray-900">{{ ucfirst(str_replace('_', ' ', $exercise->muscle_group)) }}</dd>
                        </div>
                        @if($exercise->video_url)
                            <div>
                                <dt class="text-sm font-medium text-gray-500">Video Link</dt>
                        ...
                        <div>
                            ...
                            <dd class="mt-1 text-sm text-gray-900">{{ $exercise->created_at->format('M d, Y') }}</dd>
                        </div>
                    </dl>
                </div>
