...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="{{ auth()->user()->dark_mode ? 'dark' : '' }}">
    ...
    <body class="font-sans antialiased bg-white dark:bg-gray-950">
        ...
        <div class="fixed top-0 left-0 right-0 bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 z-40">
            ...
            <nav class="hidden md:flex justify-center items-center border-t border-gray-100 dark:border-gray-800 max-w-4xl mx-auto px-4 h-12 gap-1">
                <a href="{{ route('client.dashboard') }}"
                   ...
                   @if(request()->routeIs('client.dashboard')) style="color: var(--color-primary); border-color: var(--color-primary)" @endif>
                ...
                <a href="{{ route('client.program') }}"
                   ...
                   @if(request()->routeIs('client.program*')) style="color: var(--color-primary); border-color: var(--color-primary)" @endif>
                ...
                <a href="{{ route('client.log') }}"
                   ...
                   @if(request()->routeIs('client.log*')) style="color: var(--color-primary); border-color: var(--color-primary)" @endif>
                ...
                <a href="{{ route('client.check-in') }}"
                   ...
                   @if(request()->routeIs('client.check-in*')) style="color: var(--color-primary); border-color: var(--color-primary)" @endif>
                ...
                <a href="{{ route('client.nutrition') }}"
                   ...
                   @if(request()->routeIs('client.nutrition*')) style="color: var(--color-primary); border-color: var(--color-primary)" @endif>
        ...
        <!-- Main Content Area -->
        <main class="pt-16 md:pt-[112px] pb-20 md:pb-6 max-w-4xl mx-auto px-4">
