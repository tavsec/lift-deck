        ...
        <nav class="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 z-40">
            <div class="max-w-4xl mx-auto">
                <div class="grid grid-cols-6 gap-1">
                    <!-- Home Tab -->
                    <a href="{{ route('client.dashboard') }}" class="flex flex-col items-center justify-center py-3 {{ request()->routeIs('client.dashboard') ? '' : 'text-gray-500' }}" {!! request()->routeIs('client.dashboard') ? 'style="color: var(--color-primary)"' : '' !!}>
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <!-- Program Tab -->
                    <a href="{{ route('client.program') }}" class="flex flex-col items-center justify-center py-3 {{ request()->routeIs('client.program*') ? '' : 'text-gray-500' }}" {!! request()->routeIs('client.program*') ? 'style="color: var(--color-primary)"' : '' !!}>
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <!-- Log Tab -->
                    <a href="{{ route('client.log') }}" class="flex flex-col items-center justify-center py-3 {{ request()->routeIs('client.log*') ? '' : 'text-gray-500' }}" {!! request()->routeIs('client.log*') ? 'style="color: var(--color-primary)"' : '' !!}>
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <!-- Check-in Tab -->
                    <a href="{{ route('client.check-in') }}" class="flex flex-col items-center justify-center py-3 {{ request()->routeIs('client.check-in*') ? '' : 'text-gray-500' }}" {!! request()->routeIs('client.check-in*') ? 'style="color: var(--color-primary)"' : '' !!}>
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <!-- Nutrition Tab -->
                    <a href="{{ route('client.nutrition') }}" class="flex flex-col items-center justify-center py-3 {{ request()->routeIs('client.nutrition*') ? '' : 'text-gray-500' }}" {!! request()->routeIs('client.nutrition*') ? 'style="color: var(--color-primary)"' : '' !!}>
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <!-- History Tab -->
                    <a href="{{ route('client.history') }}" class="relative flex flex-col items-center justify-center py-3 {{ request()->routeIs('client.history*') ? '' : 'text-gray-500' }}" {!! request()->routeIs('client.history*') ? 'style="color: var(--color-primary)"' : '' !!}>
